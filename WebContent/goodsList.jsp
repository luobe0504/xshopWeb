...
<link type="text/css" rel="stylesheet" href="static/css/goodsList.css" />
</head>
<body>
	<div id="Outer">
		<!--第一层-->
		...
		<!-- 第三层 -->
		<div id="lay3">
			<div class="lay3_1">&nbsp;&nbsp;&nbsp;&nbsp;商品列表</div>
			<div class="lay3_2">
				<div class="lay3_2_1"><img src="static/img/left1.png"></div>
				<div class="lay3_2_2"><img src="static/img/right2.png"></div>
			</div>
		</div>
		<!--第四层-->
		<div id="lay4">
